...
const MESSAGE_BY_CODE: Partial<Record<ErrorCode | string, string>> = {
  ...
  SOCIAL_OAUTH_INVALID_CLIENT: "This provider app has an invalid client identifier. Ask an admin to check the provider setup.",
  SOCIAL_OAUTH_MISSING_SCOPES: "This provider app is missing a required approved permission. Ask an admin to review the provider setup.",
  SOCIAL_OAUTH_REDIRECT_MISMATCH: "This provider app redirect URL does not match the provider setup.",
